...
$z,z_0,\cdots,z_{(n-1)}$.  Depending on context, this sequence may
have its components separated by commas, or merely juxtaposed.
...
Figure~\ref{fig:futhark-ir} shows the (simplified) IR of Futhark,
...
SOAC operators, are given in Figure~\ref{fig:soacType}, and an
informal description of them is given in Figure~\ref{fig:soacDesc}.
...
Figure~\ref{fig:uniqueness-rules} defines a \textit{sequencing} judgment
