...
\caption{Typing rules for Futhark's core IR, excluding expressions, which are shown on \cref{fig:srcTypeRulesExps}}
...
\textrm{TySch}(\emph{op}) \geq (\nseq{\etau}{n}) \rightarrow \rho \sp \vdp p : \rho \sp \Gamma,p \vd e : \rho'}
{\Gamma \vd \Let{p}{\emph{op}~\nseq{a}{n}}{e} : \rho'}
