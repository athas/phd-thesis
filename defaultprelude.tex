...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Palatino doesn't have all the emoticons, use Symbola for that block
% but use Palatino for punctuation classes
\usepackage{ucharclasses}
\newfontfamily\emotifont{Symbola}
\newfontfamily\punctfont{EB Garamond SC}
\setTransitionsForSymbols{\emotifont}{\normalfont}
\setTransitionsForMathematics{\emotifont}{\normalfont}
\setTransitionsForPunctuation{\punctfont}{\normalfont}
