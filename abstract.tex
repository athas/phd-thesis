...
First, we present a \textit{moderate flattening} transformation aimed
at enhancing the degree of parallelism, which is capable of exploiting
...
for parallel programming in practice.
